...
if (isset($_POST["id"]) &&
    ...
    {
        echo '<br>';
        echo 'DEBUG: The MySQL Query (editing a row) has failed.';
    }
    else
    {
        //echo 'DEBUG: Row edited successfully.';
    }
...
echo <<<HTML
    ...
    <form action="" method="post">
        <fieldset>
            ...
            <p><b>Please enter the ID of the book to change, and its new information below:</b> <br><br>
